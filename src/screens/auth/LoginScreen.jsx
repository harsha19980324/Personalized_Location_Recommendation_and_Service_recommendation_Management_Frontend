  ...
  return (
    <View style={styles.container}>
      <OnboardFlow
        ...
        pageStyle={{paddingTop: 145}}
        pages={[
          {
            title: 'Welcome to Travel Buddy',
            subtitle: '',
            imageUri: 'https://i.ibb.co/BfXSDDx/Travel-Buddy-Logo.png',
          },
          {
            title: 'Early Disease Risk Identification',
            subtitle:
              'Identify disease risks early. So you can take quick actions',
            imageUri:
          ...
          },
          {
            ...
            subtitle: 'Display real-time sensor data',
            imageUri:
